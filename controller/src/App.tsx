    ...
    <SendContext value={send}>
      <div className="app" data-theme={theme}>
        <header className="app-header">
          <div className="brand-logos" aria-label="Partner logos">
            <div className="algoriddim-logo" aria-label="algoriddim">
              <span>algoriddim</span>
              <i aria-hidden="true" />
            </div>
            <div className="unicorner-logo" aria-label="Unicorner">
